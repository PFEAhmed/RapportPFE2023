...
\FloatBarrier
         \centering
        \includegraphics[width=1\textwidth]{UseCase Diagram1}
...
\FloatBarrier
         \centering
        \includegraphics[width=1\textwidth]{Activity Diagram1}
...
\FloatBarrier
         \centering
        \includegraphics[width=16cm, height=10cm]{RequirementDiagram1}
...
\FloatBarrier
         \centering
        \includegraphics[width=1\textwidth]{Block Definition Diagram1}
...
\end{itemize}
\subsection{reflection on the Brightness and contrast adjustment process}
