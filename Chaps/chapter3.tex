...
\subsubsection{ setting up the OS }
\begin{itemize}
...
\hfill
\begin{minipage}{0.5\textwidth}
\hspace*{0.3in}\includegraphics[width=\textwidth]{3i}
\end{minipage}
\vspace{0.5in}
\item 
\begin{minipage}{0.5\textwidth}
...
\hfill
\begin{minipage}{0.5\textwidth}
\hspace*{0.3in}\includegraphics[width=\textwidth]{8i}
\end{minipage}
\vspace{0.5in}
\item 
\begin{minipage}{0.5\textwidth}
...
\hfill
\begin{minipage}{0.5\textwidth}
\hspace*{0.3in}\includegraphics[width=\textwidth]{5i}
\end{minipage}
\vspace{0.5in}
\item 
\begin{minipage}{0.5\textwidth}
...
\hfill
\begin{minipage}{0.5\textwidth}
\hspace*{0.3in}\includegraphics[width=\textwidth]{9i}
\end{minipage}
\end{itemize}


\subsubsection{setting up the VNC}
\begin{itemize}
...
\\
\vspace{1cm}
Enter this command: \commandbox*{sudo raspi-config} 
...
\subsubsection{Prepare working environment}
\FloatBarrier
\begin{figure}[h]
...
To train the YOLOv5 model, we use the following line of code:
\begin{lstlisting}[language=Python]
...
\tcbox[
  ...
  boxsep=0mm,
  toptitle=0.5mm,
  bottomtitle=0.5mm, title =Training Metrics for YOLOv5s]{%
\arrayrulecolor{blue!50!black}\renewcommand{\arraystretch}{1.2}%
...
\end{tabular}}
    \addcontentsline{lot}{table}{Training Metrics for YOLOv5s}
...
\tcbox[
  ...
  boxsep=0mm,
  toptitle=0.5mm,
  bottomtitle=0.5mm, title =Validation Metrics for YOLOv5s]{%
\arrayrulecolor{blue!50!black}\renewcommand{\arraystretch}{1.2}%
...
\end{tabular}}
    \addcontentsline{lot}{table}{Validation Metrics for YOLOv5s}
...
\tcbox[
  ...
  boxsep=0mm,
  toptitle=0.5mm,
  bottomtitle=0.5mm, title =Testing Metrics for YOLOv5s]{%
\arrayrulecolor{blue!50!black}\renewcommand{\arraystretch}{1.2}%
...
\end{tabular}}
    \addcontentsline{lot}{table}{Testing Metrics for YOLOv5s}
...
\tcbox[width=\linewidth,
  ...
  boxsep=0mm,
  toptitle=0.5mm,
  bottomtitle=0.5mm, title = Detection time results for Raspberry Pi 4 and Raspberry Pi 3]{%
\arrayrulecolor{blue!50!black}\renewcommand{\arraystretch}{1.2}%
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Raspberry Pi Model} & \textbf{Number of Detections} & \textbf{Average Detection Time (s)} & \textbf{Range (s)} \\ \hline
Raspberry Pi 4              & 500                           & 0.8843                              & 0.8687 - 0.9248    \\ \hline
Raspberry Pi 3              & 500                           & 3.2731                              & 3.2186 - 3.3478    \\ \hline
\end{tabular}}
    \addcontentsline{lot}{table}{Detection time results for Raspberry Pi 4 and Raspberry Pi 3}
\end{table}
\FloatBarrier
...
In my project, I designed a PCB relay module using Proteus software. I started by creating a new project and selecting the schematic capture option.As you can see in figure \ref{Schematic Capture of the relay}, I added all the necessary components such as the relay, terminal blocks, and supporting elements like diodes or resistors. I carefully connected the components together, making sure the signals flowed correctly by drawing wires between their pins. To ensure clarity, I included labels and annotations.
